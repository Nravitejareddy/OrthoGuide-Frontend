...
class ScheduleActivity : AppCompatActivity() {
    ...
    private fun loadAppointments() {
        ...
        com.simats.orthoguide.network.RetrofitClient.service.getClinicianSchedule(teacherId, dateStr)
            .enqueue(object : retrofit2.Callback<List<com.simats.orthoguide.network.ScheduleItem>> {
                override fun onResponse(
                    call: retrofit2.Call<List<com.simats.orthoguide.network.ScheduleItem>>,
                    response: retrofit2.Response<List<com.simats.orthoguide.network.ScheduleItem>>
                ) {
                ...
                override fun onFailure(call: retrofit2.Call<List<com.simats.orthoguide.network.ScheduleItem>>, t: Throwable) {
                    timeslotsContainer.removeAllViews()
    ...
    private fun addApptView(item: com.simats.orthoguide.network.ScheduleItem) {
        ...
        ivComplete.setOnClickListener {
            ...
            com.simats.orthoguide.util.DialogUtils.showConfirmDialog(
                ...
                onConfirm = {
                    ...
                    com.simats.orthoguide.network.RetrofitClient.service.completeAppointment(apptId)
                        .enqueue(object : retrofit2.Callback<com.simats.orthoguide.network.GenericResponse> {
                            override fun onResponse(
                                call: retrofit2.Call<com.simats.orthoguide.network.GenericResponse>,
                                response: retrofit2.Response<com.simats.orthoguide.network.GenericResponse>
                            ) {
                                if (response.isSuccessful) {
                                    timeslotsContainer.removeView(view)
                                    if (timeslotsContainer.childCount == 0) showEmptyState()
                                    com.simats.orthoguide.util.DialogUtils.showSuccessSnackbar(
                                        findViewById(android.R.id.content),
                                        "Appointment marked as completed"
                                    )
                                } else {
                                    com.simats.orthoguide.util.DialogUtils.showError(this@ScheduleActivity, "Failed to complete")
                                }
                            }

                            override fun onFailure(call: retrofit2.Call<com.simats.orthoguide.network.GenericResponse>, t: Throwable) {
                                com.simats.orthoguide.util.DialogUtils.showError(this@ScheduleActivity, "Network error")
                            }
                        })
                }
            )
        ...
        ivDelete.setOnClickListener {
            ...
            com.simats.orthoguide.util.DialogUtils.showConfirmDialog(
                ...
                cancelText = "Keep It",
                onConfirm = {
                    com.simats.orthoguide.network.RetrofitClient.service.deleteAppointment(apptId)
                        .enqueue(object : retrofit2.Callback<com.simats.orthoguide.network.GenericResponse> {
                            override fun onResponse(
                                call: retrofit2.Call<com.simats.orthoguide.network.GenericResponse>,
                                response: retrofit2.Response<com.simats.orthoguide.network.GenericResponse>
                                ...
                                if (response.isSuccessful) {
                                    loadAppointments()
                                    com.simats.orthoguide.util.DialogUtils.showSuccessSnackbar(findViewById(android.R.id.content), "Appointment cancelled successfully")
                                } else {
                                    com.simats.orthoguide.util.DialogUtils.showError(this@ScheduleActivity, "Failed to cancel")
                                }
                            }
