...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun fetchUnreadCount() {
        ...
        RetrofitClient.service.getUnreadNotificationsCount(userId, "patient").enqueue(object : Callback<com.simats.orthoguide.network.UnreadCountResponse> {
            override fun onResponse(call: Call<com.simats.orthoguide.network.UnreadCountResponse>, response: Response<com.simats.orthoguide.network.UnreadCountResponse>) {
            ...
            override fun onFailure(call: Call<com.simats.orthoguide.network.UnreadCountResponse>, t: Throwable) {
