...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (etPassword != null && ivTogglePassword != null) {
            com.yourname.orthoguide.util.PasswordToggleHelper.setupPasswordToggle(etPassword, ivTogglePassword)
        }
        ...
        btnSignup.setOnClickListener {
            ...
            if (name.isEmpty() || email.isEmpty() || password.isEmpty()) {
                com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), "Please fill in all fields")
            ...
            RetrofitClient.service.sendOtp(payload).enqueue(object : Callback<GenericResponse> {
                override fun onResponse(call: Call<GenericResponse>, response: Response<GenericResponse>) {
                    ...
                    if (response.isSuccessful) {
                        com.yourname.orthoguide.util.DialogUtils.showSuccess(findViewById(android.R.id.content), "OTP sent to $email")
                        ...
                        com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), "Failed to send OTP")
                    }
                }
