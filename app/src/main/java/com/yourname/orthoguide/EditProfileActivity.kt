...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.btn_save)?.setOnClickListener {
            ...
            if (name.isEmpty()) {
                com.yourname.orthoguide.util.DialogUtils.showError(this, "Name cannot be empty")
    ...
    private fun fetchProfileData(role: String, id: String, etName: EditText, etEmail: EditText, etPhone: EditText) {
        ...
        call.enqueue(object : Callback<com.yourname.orthoguide.network.ProfileResponse> {
            override fun onResponse(call: Call<com.yourname.orthoguide.network.ProfileResponse>, response: Response<com.yourname.orthoguide.network.ProfileResponse>) {
            ...
            override fun onFailure(call: Call<com.yourname.orthoguide.network.ProfileResponse>, t: Throwable) {
        ...
        call.enqueue(object : Callback<GenericResponse> {
            override fun onResponse(call: Call<GenericResponse>, response: Response<GenericResponse>) {
                if (response.isSuccessful) {
                    ...
                    com.yourname.orthoguide.util.DialogUtils.showError(this@EditProfileActivity, "Failed to update profile")
                }
            }

            override fun onFailure(call: Call<GenericResponse>, t: Throwable) {
                Log.e("OrthoGuide", "Profile update failed", t)
                com.yourname.orthoguide.util.DialogUtils.showError(this@EditProfileActivity, "Network error. Try again.")
            }
        })
    }
}
