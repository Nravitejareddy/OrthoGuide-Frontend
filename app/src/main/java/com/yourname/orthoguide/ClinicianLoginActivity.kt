...
import com.yourname.orthoguide.network.LoginRequest
import com.yourname.orthoguide.network.LoginResponse
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.btn_login)?.setOnClickListener {
            ...
            if (providerId.isEmpty() || password.isEmpty()) {
                com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(findViewById(android.R.id.content), "Please enter both ID and Password")
        ...
        RetrofitClient.service.login(loginRequest).enqueue(object : Callback<LoginResponse> {
            override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                if (response.isSuccessful) {
                    ...
                    com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(findViewById(android.R.id.content), "Invalid Credentials")
                }
            }

            override fun onFailure(call: Call<LoginResponse>, t: Throwable) {
                Log.e("OrthoGuide", "Login failed", t)
                com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(findViewById(android.R.id.content), "Connection Error")
            }
        })
    }
