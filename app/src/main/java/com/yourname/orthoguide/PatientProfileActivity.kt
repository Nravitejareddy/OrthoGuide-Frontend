...
import com.yourname.orthoguide.network.PatientIssueItem
...
class PatientProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSaveChanges?.setOnClickListener {
            ...
            com.yourname.orthoguide.network.RetrofitClient.service.adminUpdateUser(request).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                    if (response.isSuccessful) {
                        com.yourname.orthoguide.util.DialogUtils.showSuccessSnackbar(findViewById(android.R.id.content), "Changes saved successfully")
                        ...
                        com.yourname.orthoguide.util.DialogUtils.showError(this@PatientProfileActivity, "Failed to update database")
                    }
                }
                ...
                override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                    btnSaveChanges?.isEnabled = true
                    btnSaveChanges?.text = "Save Changes"
                    com.yourname.orthoguide.util.DialogUtils.showError(this@PatientProfileActivity, "Network error")
                }
            })
        }
        ...
        fun showScheduleBottomSheet() {
            ...
            fun performAutoSave(isManualConfirm: Boolean = false): Boolean {
                ...
                if (dateText == "Select Date" || timeText == "Select Time") {
                    if (isManualConfirm) {
                        com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(anchor, "Please select both a date and a time.")
                    }
                    return false
                }
                ...
                if (sessionId != -1) {
                    ...
                    com.yourname.orthoguide.network.RetrofitClient.service.rescheduleAppointment(reschReq).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                        override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                            isSavingAppt = false
                            ...
                            if (response.isSuccessful) {
                                ...
                                if (isManualConfirm) {
                                    com.yourname.orthoguide.util.DialogUtils.showSuccessSnackbar(anchor, "Session saved successfully")
                                ...
                                com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(anchor, parsedMsg)
                            }
                        }
                        override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                            isSavingAppt = false
                            view.findViewById<android.widget.Button>(R.id.btn_confirm_session)?.isEnabled = true
                            com.yourname.orthoguide.util.DialogUtils.showErrorSnackbar(anchor, "Network error: ${t.message}")
                        }
                    })
                } else {
                    val request = mapOf(
                    ...
                    com.yourname.orthoguide.network.RetrofitClient.service.clinicianAddSchedule(request).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                        override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                            isSavingAppt = false
                            view.findViewById<android.widget.Button>(R.id.btn_confirm_session)?.isEnabled = true
                            ...
                            if (response.isSuccessful) {
                                ...
                                if (isManualConfirm) {
                                    com.yourname.orthoguide.util.DialogUtils.showSuccessSnackbar(anchor, "Session planned successfully")
                                    bottomSheetDialog.dismiss()
                                }
        ...
        findViewById<View>(R.id.btn_cancel_appt)?.setOnClickListener {
            ...
            com.yourname.orthoguide.util.DialogUtils.showConfirmDialog(
                ...
                cancelText = "Keep It",
                onConfirm = {
                    com.yourname.orthoguide.network.RetrofitClient.service.deleteAppointment(sessionId).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                        override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                            if (response.isSuccessful) {
                                prefs.edit().apply {
                                ...
                                com.yourname.orthoguide.util.DialogUtils.showSuccessSnackbar(findViewById(android.R.id.content), "Session cancelled")
                                updateAppointmentUI(false)
                            } else {
                                com.yourname.orthoguide.util.DialogUtils.showError(this@PatientProfileActivity, "Failed to cancel")
                            }
                        }
                        override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                            com.yourname.orthoguide.util.DialogUtils.showError(this@PatientProfileActivity, "Network error")
    ...
    private fun fetchPatientProfile(patientId: String) {
        com.yourname.orthoguide.network.RetrofitClient.service.getPatientProfileById(patientId)
            .enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.ProfileResponse> {
                ...
                override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.ProfileResponse>, t: Throwable) {
    ...
    private fun fetchPatientIssues(patientId: String) {
        ...
        com.yourname.orthoguide.network.RetrofitClient.service.getPatientIssues(cleanId).enqueue(object : retrofit2.Callback<List<com.yourname.orthoguide.network.PatientIssueItem>> {
            override fun onResponse(call: retrofit2.Call<List<com.yourname.orthoguide.network.PatientIssueItem>>, response: retrofit2.Response<List<com.yourname.orthoguide.network.PatientIssueItem>>) {
                if (response.isSuccessful) {
            ...
            override fun onFailure(call: retrofit2.Call<List<com.yourname.orthoguide.network.PatientIssueItem>>, t: Throwable) {
