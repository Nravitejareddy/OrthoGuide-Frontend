    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.btn_login_secure)?.setOnClickListener {
            ...
            if (patientId.isEmpty() || password.isEmpty()) {
                com.yourname.orthoguide.util.DialogUtils.showError(this, "Please enter both ID and Password")
            } else {
        ...
        RetrofitClient.service.login(loginRequest).enqueue(object : Callback<LoginResponse> {
            override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                if (response.isSuccessful) {
                    ...
                    com.yourname.orthoguide.util.DialogUtils.showError(this@PatientLoginActivity, "Invalid Credentials")
                }
            }

            override fun onFailure(call: Call<LoginResponse>, t: Throwable) {
                Log.e("OrthoGuide", "Login failed", t)
                com.yourname.orthoguide.util.DialogUtils.showError(this@PatientLoginActivity, "Connection Error: ${t.message}")
            }
        })
    }
