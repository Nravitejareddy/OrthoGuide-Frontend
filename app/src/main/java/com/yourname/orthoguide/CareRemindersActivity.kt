...
class CareRemindersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            com.yourname.orthoguide.util.DialogUtils.showError(this, "Init error: ${e.message}")
        }
    }
    ...
    private fun fetchSettings() {
        ...
        try {
            com.yourname.orthoguide.network.RetrofitClient.service.getNotificationSettings(userId).enqueue(object : retrofit2.Callback<Map<String, Any>> {
    ...
    private fun saveSettings() {
        ...
        try {
            val request = com.yourname.orthoguide.network.NotificationSettingsRequest(
                patientId = userId,
            ...
            com.yourname.orthoguide.network.RetrofitClient.service.updateNotificationSettings(request).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                    if (response.isSuccessful) {
                        com.yourname.orthoguide.util.DialogUtils.showSuccess(this@CareRemindersActivity, "Preferences updated")
                    } else {
                        com.yourname.orthoguide.util.DialogUtils.showError(this@CareRemindersActivity, "Network error")
                    }
                }
                override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                    com.yourname.orthoguide.util.DialogUtils.showError(this@CareRemindersActivity, "Update failed")
                }
            })
        } catch (e: Exception) {
            com.yourname.orthoguide.util.DialogUtils.showError(this, "Save error: ${e.message}")
        }
    }
}
