...
class ReportIssueActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoxes = listOf(
            R.id.cb_loose_bracket, R.id.cb_poking_wire, R.id.cb_lost_aligner,
            R.id.cb_severe_pain, R.id.cb_swollen_gums, R.id.cb_broken_appliance
        ).map { findViewById<android.widget.CheckBox>(it) }
        ...
        btnContinue?.setOnClickListener {
            startActivity(Intent(this, SeverityLevelActivity::class.java))
        }
    }
}
