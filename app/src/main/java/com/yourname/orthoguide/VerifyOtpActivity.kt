...
class VerifyOtpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<MaterialButton>(R.id.btn_verify_continue)?.setOnClickListener { btn ->
            ...
            com.yourname.orthoguide.network.RetrofitClient.service.verifyOtp(mapOf("email" to email, "otp" to otpCode))
                    ...
                    override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                        if (response.isSuccessful) {
                            if (action == "signup") {
                                ...
                                com.yourname.orthoguide.network.RetrofitClient.service.signup(payload).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                                    override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                                        btnVerify.isEnabled = true
                                        btnVerify.text = "Verify & Continue"
                                        if (response.isSuccessful) {
                                            com.yourname.orthoguide.util.DialogUtils.showSuccess(findViewById(android.R.id.content), "Account Created")
                                            val loginIntent = android.content.Intent(this@VerifyOtpActivity, MainActivity::class.java)
                                            startActivity(loginIntent)
                                            finishAffinity()
                                        } else {
                                            com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), "Signup Failed")
                                        }
                                    }
                                    override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                                        btnVerify.isEnabled = true
                                        btnVerify.text = "Verify & Continue"
                                        com.yourname.orthoguide.util.DialogUtils.showError(this@VerifyOtpActivity, "Network Error")
                                    }
                                })
                            } else {
                                btnVerify.isEnabled = true
                            ...
                            btnVerify.isEnabled = true
                            btnVerify.text = "Verify & Continue"
                            com.yourname.orthoguide.util.DialogUtils.showError(this@VerifyOtpActivity, "Invalid OTP")
                        }
                    }
                    override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                        btnVerify.isEnabled = true
    ...
    private fun resendOtp(email: String) {
        ...
        com.yourname.orthoguide.network.RetrofitClient.service.sendOtp(mapOf("email" to email, "role" to userRole))
            .enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                    if (response.isSuccessful) {
                        val root = findViewById<android.view.View>(R.id.verify_otp_root)
                        if (root != null) {
                            com.yourname.orthoguide.util.DialogUtils.showSuccess(root, "OTP Resent")
                        } else {
                            com.yourname.orthoguide.util.DialogUtils.showSuccess(this@VerifyOtpActivity, "OTP Resent")
                        }
                        startResendTimer()
                    } else {
                        com.yourname.orthoguide.util.DialogUtils.showError(this@VerifyOtpActivity, "Failed to resend OTP")
