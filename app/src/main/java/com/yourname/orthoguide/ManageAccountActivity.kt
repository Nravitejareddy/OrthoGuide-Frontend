...
class ManageAccountActivity : AppCompatActivity() {
    ...
    private fun performDeactivation() {
        ...
        com.yourname.orthoguide.network.RetrofitClient.service.selfDeactivateAccount(request).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
            override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                if (response.isSuccessful) {
                    ...
                    com.yourname.orthoguide.util.DialogUtils.showSuccessDialog(
