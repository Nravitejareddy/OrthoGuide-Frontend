...
class ForgotPasswordActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSendOtp?.setOnClickListener {
            ...
            com.yourname.orthoguide.network.RetrofitClient.service.sendOtp(mapOf("email" to email, "role" to role)).enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
