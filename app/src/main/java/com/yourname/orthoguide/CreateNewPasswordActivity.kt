    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnResetPassword.setOnClickListener {
            ...
            if (newPwd != confirmPwd) {
                com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), "Passwords do not match")
                return@setOnClickListener
            }
            ...
            if (btnResetPassword.isEnabled) {
                ...
                com.yourname.orthoguide.network.RetrofitClient.service.resetPassword(mapOf("email" to email, "new_password" to newPwd, "role" to role))
                    .enqueue(object : retrofit2.Callback<com.yourname.orthoguide.network.GenericResponse> {
                        override fun onResponse(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, response: retrofit2.Response<com.yourname.orthoguide.network.GenericResponse>) {
                            ...
                            if (response.isSuccessful) {
                                ...
                                com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), errorMessage)
                            }
                        }
                        ...
                        override fun onFailure(call: retrofit2.Call<com.yourname.orthoguide.network.GenericResponse>, t: Throwable) {
                            btnResetPassword.isEnabled = true
                            btnResetPassword.text = "Reset Password"
                            com.yourname.orthoguide.util.DialogUtils.showError(findViewById(android.R.id.content), "Network error")
                        }
                    })
            }
        }
